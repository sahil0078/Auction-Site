...
<?php
		...
		if($pname)
		{
			...
			$sql="select userid,amount from bids where pid=(select pid from products where product_name='".$pname."') order by amount desc";
			...
			else
			{
				...
				{
					echo "<tr><td>".$arr['userid']."</td>";
					echo "<td>".$arr['amount']."</td></tr>";
				}
				echo "</table>";
			}
		}
